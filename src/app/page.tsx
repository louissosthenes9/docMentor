  ...
  return (
      <>
        <MaxWidthWrapper className="mb-12 text-center mt-28 sm:mt-40 items-center justify-center flex flex-col">
          <div className="mx-auto mb-4 flex max-w-fit justify-center rounded-full border-gray-200 px-7 py-2 hover:bg-white/50 hover:border-gray-300 shadow-md backdrop-blur space-x-3 overflow-hidden transition-all">
          ...
          <ol className="my-8 space-y-4 md:flex md:space-x-12 md:space-y-0">
            <li className="md:flex-1">
              <div className="flex flex-col space-y-2 border-l-4 pl-4 md:pl-0 md:border-t-2 md:pb-0 py-2 border-zinc-300">
                ...
                Try out our free plan or choose our{" "}
                  <Link
            ...
            <li className="md:flex-1">
              <div className="flex flex-col space-y-2 border-l-4 pl-4 md:pl-0 md:border-t-2 md:pb-0 py-2 border-zinc-300">
                ...
                <span className="mt-2 text-zinc-700">
                We&apos;ll process your file and get ready to elaborate it according to your needs
              </span>
              </div>
            </li>
            ...
            <li className="md:flex-1">
              <div className="flex flex-col space-y-2 border-l-4 pl-4 md:pl-0 md:border-t-2 md:pb-0 py-2 border-zinc-300">
                ...
                <span className="text-xl font-semibold">Then start to ask questions</span>
                <span className="mt-2 text-zinc-700">
